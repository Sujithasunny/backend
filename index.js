...
// // Route to render the product creation form
// app.get('/form', (req, res) => {
//     res.render('form');
// });

// // Route to handle the form submission and create a new product
...
//     res.redirect('/'); // Redirect to the home page after saving the product
// });
